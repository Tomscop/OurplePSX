...
#define STAGE_LOAD_PLAYER3    (1 << 2) //Reload 3rd player character
#define STAGE_LOAD_PLAYER4    (1 << 3) //Reload 4th player character
#define STAGE_LOAD_PLAYER5    (1 << 4) //Reload 5th player character
...
#define STAGE_LOAD_STAGE      (1 << 9) //Reload stage
#define STAGE_LOAD_FLAG       (1 << 10)
...
typedef struct
{
	...
	struct
	{
		Character* (*new)();
		fixed_t x, y;
	} pchar, pchar2, pchar3, pchar4, pchar5, ochar, ochar2, ochar3, gchar;
